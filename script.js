...
// תמונת ברירת מחדל נקייה במידה ולא הועלתה תמונה
...
async function loadBooks() {
  ...
  if (error) {
    console.error('שגיאה שטעינת המודעות:', error);
    return;
  }
...
// ניהול פתיחה וסגירה של החלונית המודאלית
